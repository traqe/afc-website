        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li id="advanced" class="active"><a onclick="change_advanced()">Car Entertainment</a></li>
            </ul>
          </div><!-- Widget end -->
        </div><!-- Sidebar end -->
      </div><!-- Sidebar Col end -->
        ...
        <div class="content-inner-page">
          ...
          <div class="row" id="floating">
            <div style="text-align: justify" class="col-md-12">
              <h2 class="column-title mrt-0">Car Entertainment</h2>
                  ...
                  <div class="card-header p-0 bg-transparent" id="headingOne">
                    <h2 class="mb-0">
                      <button class="btn btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        what is the advantage of having entertainment in your car?
                      </button>
                    </h2>
                  </div>
