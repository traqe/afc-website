...
<section id="main-container" class="main-container">
                ...
                <div class="content-inner-page">
                    <div class="row">
                        <div class="col-md-12" id="about">
                            ...
                            <h5>
                                <p>G-I-Systems gather, manage & analyze data. We analyze spatial location and organize layers of information into visualizations using maps and 3D scenes revealing patterns, relationships,& situations to users to make smarter decisions.
                                    We serve the Local Government, Mining, Engineering, Telecomunications, Wildlife & Transport industries.
                                    We also sell top quality Unmanned Aerial Vehicles (Drones)</p>
                            </h5>
                        </div><!-- col end -->
                    </div><!-- 1st row end-->
    ...
    <div hidden class="col-md-12" id="remote">
        ...
        <h5>
            <p> Remote sensing is the process of detecting and monitoring the physical
            ...
            <p> some of the uses of remotes senses are:
        </h5>
        </p>
        <ul class="list-arrow">
