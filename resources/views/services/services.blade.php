      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="banner-heading">
            <h1 style="color: rgb(64,64,180)" class="banner-title">Service</h1>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item"><a style="color: rgb(64,64,180)" href="/afc">Home</a></li>
                <li class="breadcrumb-item"><a style="color: rgb(64,64,180)" href="#ts-service-area">Services</a></li>
